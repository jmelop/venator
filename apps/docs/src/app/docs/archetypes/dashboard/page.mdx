...
<CodeBlock language="bash" code={`npx venator init dashboard`} />

Once deployed:

<CodeBlock language="bash" code={`cd my-dashboard\nnpm install\nnpm run dev`} />
...
<CodeBlock language="bash" code={`npx venator add page-header`} />

<div className="mt-4" />

Install Venator UI components directly:

<CodeBlock language="bash" code={`npm install @venator/ui`} />