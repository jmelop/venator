...
import { Terminal } from '@venator-ui/ui';
      ...
      <div className="relative z-10 flex flex-col items-center gap-6 w-full">
        ...
        <div className="flex items-center gap-3 flex-wrap justify-center">
          <Link href="/docs/getting-started/introduction">
            <button className="inline-flex items-center gap-2 font-medium text-[13.5px] px-4 h-9 rounded-md transition-colors"
          ...
          <a href="https://github.com/jmelop/venator-ui" target="_blank" rel="noopener noreferrer">
            <button className="inline-flex items-center gap-2 font-medium text-[13.5px] px-4 h-9 rounded-md transition-colors"
              style={{ background: 'transparent', color: 'var(--fg)', border: '1px solid var(--line-2)' }}>
